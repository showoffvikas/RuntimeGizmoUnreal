...
public class RuntimeGizmosUE5 : ModuleRules
{
    ...
    public RuntimeGizmosUE5(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PrivateDependencyModuleNames.AddRange(new string[] { "MeshDescription", "StaticMeshDescription" , "EnhancedInput" });
